...
namespace Excel
{
    class Program
    {
        static void Main(string[] args)
        {
          ...
          xlApp.Visible = true;
          xlWorkBook = xlApp.Workbooks.Open(@"C:\Users\Svetlio-PC\Documents\Valerii_09.xlsx", 0, false, 5, "", "", true, Microsoft.Office.Interop.Excel.XlPlatform.xlWindows, "\t", false, false, 0, true, 1, 0);
        ...
        //}
           ...
           for (int i = 1; i < 4357; i++)
           {
                try
               {
                  ...
                  xlRange.Cells[i, 3] = valerii.Price;

                   xlRange.Cells[i, 4] = valerii.Barcode;

                  xlRange.Cells[i, 5] = valerii.Title;

                   xlRange.Cells[i, 6] = valerii.Model;

                   xlRange.Cells[i, 7] = valerii.Picture;

                   xlRange.Cells[i, 8] = valerii.Weight;

                    xlRange.Cells[i, 9] = valerii.Brand;
