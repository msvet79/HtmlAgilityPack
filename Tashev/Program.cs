...
namespace Tashev
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            xlWorkBook = xlApp.Workbooks.Open(@"C:\Users\Svetlio-PC\Documents\Tashev_URL.xlsx", 0, false, 5, "", "", true, Microsoft.Office.Interop.Excel.XlPlatform.xlWindows, "\t", false, false, 0, true, 1, 0);
